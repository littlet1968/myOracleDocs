...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        # actions for the sync menu
        self.action_SyncAll = QtWidgets.QAction(MainWindow)
        self.action_SyncAll.setObjectName("action_SyncAll")
        self.action_SyncConnect = QtWidgets.QAction(MainWindow)
        self.action_SyncConnect.setObjectName("action_SyncConnect")
        ...
        # sync menu
        self.menu_Sync.addAction(self.action_SyncAll)
        self.menu_Sync.addAction(self.action_SyncConnect)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.action_SyncAll.setText(_translate("MainWindow", "Sync &All"))
        self.action_SyncConnect.setText(_translate("MainWindow",
                                                   "Sync &Connect"))
